...
venue_list = [
  ...
  [ 4, "Bodega's Alley", "1418 O St, Lincoln, NE", "Good Times. Good People. Lincoln's home for JAM music since 1996.", "http://www.exploredowntown.org/_files/images/bod_2.jpg", 40.813882, -96.70058389999997, "http://www.bodegasalley.com/", "http://i.imgur.com/b8d73ou.png"],
  [ 5, "Single Barrel", "130 N 10th St, Lincoln, NE", "Down-home steak joint offering locally sourced meats & craft beers, plus a whiskey bar & live music.", "http://www.thesinglebarrel.com/wp-content/plugins/nivo-slider/timthumb.php?src=http://www.thesinglebarrel.com/wp-content/uploads/2012/08/img_26701.jpg&h=245&w=662&zc=1&q=100", 40.814451, -96.706641, "http://www.thesinglebarrel.com/", "http://i.imgur.com/RuS3Wy4.png"],
  [ 6, "Zoo Bar", "136 N 14th St, Lincoln, NE", "Happening tavern delivering live blues & jazz music almost every night of the week since 1973.", "https://i.imgur.com/UxOkTpI.jpg", 40.712784, -74.005941, "http://www.zoobar.com/ZOOFEST-News.html", "http://i.imgur.com/ZycuHbI.png"]
]
venue_list.each do |id, name, address, info, img, latitude, longitude, website, map_icon|
  Venue.create(id: id, name: name, address: address, info: info, remote_img_url: img, latitude: latitude, longitude: longitude, website: website, remote_map_icon_url: map_icon)
end
...
events_list = [
  ...
  [4,1,21,"2016-10-07 19:00:00","2016-10-07 19:30:00"],
